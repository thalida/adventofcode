...
def run(raw_logs):
    ...
    for entry in sorted_logs:
        ...
        for i in range(minutes):
            ...
            sleepist_amount = curr_guard_data['sleep_minutes'].get(curr_guard_data['sleepiest_minute'], 0)
            if amount_slept > sleepist_amount:
                curr_guard_data['sleepiest_minute'] = minute
        ...
        elif curr_guard_data['total_sleep'] > sleepiest_guard['total_sleep']:
            sleepiest_guard = curr_guard_data
